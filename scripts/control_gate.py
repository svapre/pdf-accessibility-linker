"""Compatibility wrapper for control-loop toolkit control gate."""
...
def _wire_toolkit_path() -> None:
    ...
    if not toolkit_root.exists():
        raise RuntimeError(
            ...
            "Initialize submodules before running control gates."
        )
...
from control_loop.control_gate import *  # noqa: F403
